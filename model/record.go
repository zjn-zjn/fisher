...
type Record struct {
	...
	TransferType   basic.TransferType  `json:"transfer_type" gorm:"column:transfer_type;"`               // 转移类型
...
func GetRecordTableName(accountId int64) string {
	return RecordTablePrefix + basic.GetRecordTableSuffix(accountId)
}
